...
echo -e "\e[36m[SYNC] Initializing Advanced Metadata Extraction Engine...\e[0m"

# Ensure directories exist
mkdir -p pdf site/pdf site/generated

# Create the Python Extractor Script
cat > extract_meta.py <<'PYEOF'
...
echo -e "\e[36m✅ System synchronization and metadata extraction complete.\e[0m"
