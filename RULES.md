...
## מה נשאר לעשות
1. לבדוק ידנית בדפדפן את מצב הגלילה הרציפה
2. לבדוק ידנית שמעבר בין 1 / 2 / 3 עמודים נשאר נוח
3. לבדוק ידנית את איכות ההדפסה
4. להחליט אם צריך שלב ג' נוסף או שהקורא הגיע למצב מספק
