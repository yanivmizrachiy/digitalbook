...
## מה נשאר לעשות
1. לבדוק ידנית בדפדפן שמצבי 1/2/3 עמודים נוחים באמת
2. לבדוק ידנית שהדפדוף בין קבוצות עמודים עובד חלק
3. לבדוק איכות הדפסה בפועל
4. לשקול בהמשך מצב גלילה רציפה מתקדם אם עדיין יהיה צורך
