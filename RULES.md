...
## מה נשאר לעשות
1. לפתוח מהנייד את reader ולבדוק שסידור הכפתורים נוח
2. לבדוק מהנייד את compare
3. לאשר שה-UX בנייד מספק
4. רק אם עדיין יש בעיה אמיתית לבצע תיקון נוסף נקודתי
