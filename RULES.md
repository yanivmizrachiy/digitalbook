...
## מה נשאר לעשות
1. לבדוק ידנית בדפדפן מצב 1 עמוד
2. לבדוק ידנית בדפדפן מצב 2 עמודים
3. לבדוק ידנית בדפדפן מצב 3 עמודים
4. לבדוק ידנית מצב גלילה רציפה
5. לבדוק ידנית איכות הדפסה
6. רק אחרי זה להחליט אם צריך שלב ג' נוסף
