...
## מה נשאר לעשות
1. לבדוק ידנית בדפדפן ש-compare מציג בפועל שני קבצים
2. לבדוק ידנית שכפתור הורדה נוח וברור למשתמש
3. להחליט אם להרחיב את הספר מעבר ל-15 הקבצים החיים
4. לנקות בעתיד קבצי frontend לא פעילים רק אחרי אימות סופי
