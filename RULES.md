...
## מה נשאר לעשות
1. לפתוח את הקישורים מתוך STATE/qa_quick_links.md
2. לאשר ידנית שמצבי 1 / 2 / 3 נוחים
3. לאשר ידנית שמצב גלילה רציפה נוח
4. לאשר ידנית שההדפסה טובה
5. לאשר ידנית ש-compare נוח
